  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-info">
        ...
        <div class="amount">
          <span>应付总额：</span>
          <span>&yen;{{ orderInfo.payMoney }}</span>
        </div>
      </div>
      <!-- 付款方式 -->
      <div class="pay-type">
...
<script setup>
import { reqOrderInfo, baseURL } from "@/api/order";
...
// 订单详情
const orderInfo = ref({});
reqOrderInfo(route.query.id).then(({ result }) => {
...
// 支付地址
// const payUrl = '后台服务基准地址+支付页面地址+订单ID+回调地址'
